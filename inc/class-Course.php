...
class Course extends BaseCustomMediaPostType {
	...
	public function customTaxonomy() {
		...
		$this->log->error_log( $loc );
			...
			//hierarchical
		$labels = array( 'name' => 'Care Course Categories'
						, 'singular_name' => 'Care Course Category'
						, 'search_items' => 'Search Course Category'
						, 'all_items' => 'All Care Course Categories'
						, 'parent_item' => 'Parent Care Course Category'
						, 'parent_item_colon' => 'Parent Care Course Category:'
						, 'edit_item' => 'Edit Care Course Category'
						, 'update_item' => 'Update Care Course Category'
						, 'add_new_item' => 'Add New Care Course Category'
						, 'new_item_name' => 'New Care Course Category'
						, 'menu_name' => 'Care Course Categories'
						);
