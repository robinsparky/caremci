...
{ 
    ...
    const ACTION     = 'careManagementReports';
    const NONCE      = 'careManagementReports';
    ...
    public static function register() {
        ...
        error_log("$loc");
        $handler = new self();
        add_shortcode( 'care_mgmt_reports', array( $handler, 'renderReportControls' ) );
    ...
    /**
     * Render the controls that allow the user to select a report type, start and end dates 
     * and buttons to run the report and/or clear the report results
     */
    public function renderReportControls() {
        ...
        $selection = '<select id="care-report-select">';
        ...
        $out .= "<div id='care-reportmessage'></div>";
    ...
    /**
     * Get the report parameters requested when the user hits the "Run" button
     * Then run the requested report and return the results to the client side
     */
    ...
    /**
     * Retrieve the Course or Webinar data that falls between two given dates
     * @param $startDate
     * @param $endDate
     * @return Array of user meta data
     */
